...
then
    ...
    python3 compareIgnoringFloat.py syn-illumina-WHO/syn-illumina-WHO/syn-illumina-WHO.mutations.csv expected/syn-illumina-WHO/syn-illumina-WHO.mutations.csv
    echo
    echo "WHO effects"
